     ...
     window.celtra.payloads["step-3.js?v=13-fe0e22efad&secure=0"] =
       ...
       function(script, runtimeParams, trackers, openWebsiteOverrideUrls, getAppOverrideUrls, brand) {
         ...
         function ViewportManager(t) {
                 ...
                 this.width = this.originalWidth = t.width || 0,
                 this.height = this.originalHeight = t.height || 0,
                 this.iframe = this.container.ownerDocument.defaultView.frameElement, this.init()
         }
         ...
         Placement.prototype.populate = function(t, e) {
             // HOMAM: INTERESTING
             this._isPopulated ||
             (this.getContainer().appendChild(t), this.emit("populated"), this._isPopulated = !0), e && defer(e)
         },
         ...
         inherit(StickyPlacement, IframePlacement),
         StickyPlacement.prototype.setPosition = StickyPlacement.prototype.setZIndex = noop,
         StickyPlacement.prototype.show = function() {
                 IframePlacement.prototype.show.apply(this, arguments),
                 IframePlacement.prototype.setZIndex.call(this, "max"),
                 this.enableDocumentPadding(),
                 this.update()
         },
