            ...
            (function() {
                ...
                var script = document.getElementById("mobitrans-1");
                if (!script || script.tagName.toLowerCase() !== 'script')
                    throw 'Element with id equal to scriptId does not exist or is not a script.';

                var runtimeParams = {
                    "placementId":"c0e4eff3",
                    "sessionId":"s1416819036x5472f15cc22404x87387559",
                    "purpose":"live",
                    "variantChoices":{},
                    "clientTimestamp":"1416819036.339",
                    "gpsLat":"",
                    "gpsLng":"",
                    "platformAdvId":null,
                    ...
                    "ipLat":25.25819,
                    "ipLng":55.3047,
                    "ipTimeZone":"Asia\/Dubai",
                    "diDeviceType":"Desktop",
                    "diPlatform":"DesktopPlatform",
                    "diPlatformVersion":"10.10.2",
                    "clickUrl":"",
